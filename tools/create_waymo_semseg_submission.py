...
if __name__ == "__main__":
    ...
    # submission.account_name = "xiaoyang.wu.cs@gmail.com"
    # submission.unique_method_name = "PTv3"
    # submission.authors.append("Pointcept Team")
    # submission.affiliation = "Pointcept Team"
    # submission.method_link = "https://arxiv.org/abs/2312.10035"
    submission.account_name = "vvcy11222211@gmail.com"
    submission.unique_method_name = "MinkUNet"
    submission.authors.append("Chengyao Wang")
    submission.affiliation = "The Chinese University of Hong Kong"
